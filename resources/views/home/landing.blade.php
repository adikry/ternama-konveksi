...
@if ($sliders)
    @push('head')
        ...
        <meta property="og:image" content="{{ asset('storage/' . $sliders->thumbnail) }}">
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-sm-12 pb-10 px-0">
                            @if ($dataLanding->video)
                                <div class="card bg-transparent border-0">
                                    <video autoplay playinsline muted loop class="w-100 h-100">
                                        <source src="{{ asset('storage/' . $dataLanding->video) }}" type="video/mp4" />
