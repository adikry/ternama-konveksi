(function ($) {
  ...
  var APP = {
    ...
    slickCustomNav: function () {
      ...
      $(".arrow.navId-0").on("click", function (e) {
        e.preventDefault();
    ...
    slickNavCustom: function () {
      var $slicksliders = $(".nav-custom");
      if ($slicksliders.length < 1) {
        return;
      }

      $(".arrow.navId-1").on("click", function (e) {
        e.preventDefault();
        if ($(this).hasClass("slick-prev")) {
          console.log($(this));
          $slicksliders.slick("slickPrev");
        }

        if ($(this).hasClass("slick-next")) {
          $slicksliders.slick("slickNext");
        }
        $slicksliders.on("afterChange", function (slick, currentSlide) {
          if (0 === currentSlide.currentSlide) {
            $("#previous").addClass("disabled");
          } else {
            $("#previous").removeClass("disabled");
